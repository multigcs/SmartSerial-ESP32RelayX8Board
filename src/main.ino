...
void setup() {
    ...
    pinMode(26, OUTPUT); // Output(03)
    pinMode(27, OUTPUT); // Output(04)
    pinMode(14, OUTPUT); // Output(05)
        ...
        if (cmd.Generic.CommandType == LBP_COMMAND_TYPE_READ_WRITE) {
            ...
            switch (cmd.value) {
                ...
                case LBP_COMMAND_RPC_SMARTSERIAL_PROCESS_DATA: {
                    ...
                    digitalWrite(32, (pdata_in.output & (1<<0)) ? HIGH : LOW);
                    digitalWrite(33, (pdata_in.output & (1<<1)) ? HIGH : LOW);
                    digitalWrite(25, (pdata_in.output & (1<<2)) ? HIGH : LOW);
                    digitalWrite(26, (pdata_in.output & (1<<3)) ? HIGH : LOW);
                    digitalWrite(27, (pdata_in.output & (1<<4)) ? HIGH : LOW);
                    digitalWrite(14, (pdata_in.output & (1<<5)) ? HIGH : LOW);
